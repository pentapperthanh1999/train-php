...
<body>
    <div class="wrapper">
        ...
        <div class="main-content">
            <!-- Header -->
            <div class="header">
                <h2 class="header__title">Update Class</h2>
            ...
            <div class="content">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-6">
                        <form action="<?= URLROOT .'/classes/update/'. $data['class']->id ?>" method="POST" class="p-3">
                            <div class="error"><?= $data['duplicate'] ?></div>
                            <div class="form-group">
                                <label for="code">Code</label>
                                <input type="text" class="form-control" name="code" id="code" placeholder="Enter Code" value="<?= $data['class']->code ?>" />
                            </div>
                            <div class="error"><?= $data['codeError'] ?></div>
                            <div class="form-group">
                                <label for="name">Name</label>
                                <input type="text" class="form-control" name="name" id="name" placeholder="Enter Name" value="<?= $data['class']->name ?>"/>
                            </div>
